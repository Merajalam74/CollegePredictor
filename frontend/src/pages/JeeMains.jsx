...
export default function JeeMains() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/predict/mains`, formData);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        Enter your rank details to find eligible NITs, IIITs, and GFTIs.
      </p>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Select name="quota" onValueChange={handleSelectChange('quota')} defaultValue="All" required>
      ...
      <div className="space-y-4">
        ...
        {!isLoading && isSubmitted && results.length === 0 && !error && (
          <Alert>
            ...
            <AlertDescription>No colleges matched your criteria with the given rank margins. Try adjusting your inputs.</AlertDescription>
          </Alert>
        )}
